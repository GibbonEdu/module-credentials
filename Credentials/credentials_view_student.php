    ...
    if ($gibbonPersonID == false) { echo "<div class='error'>";
        ...
        if ($result->rowCount() != 1) {
            ...
            if ($search != '' or $allStudents != '') {
                ...
                echo "<a href='".$_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/Credentials/credentials_view.php&search=$search&allStudents=$allStudents'>".__($guid, 'Back to Search Results').'</a>';
                echo '</div>';
            }
